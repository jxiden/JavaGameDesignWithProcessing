 ...
 public void keyPressed() {
  ...
  if(keyCode == 65 || keyCode == 37) {
    if (player.getJsonFile().equals("sprites/slime_down.json") || player.getJsonFile().equals("sprites/slime_up.json") || player.getJsonFile().equals("sprites/slime_right.json")) {
      player = new AnimatedSprite("sprites/slime_left.png", player.getCenterX()-10.5f, player.getCenterY()-7.5f, "sprites/slime_left.json");
    }
    left = true;
  }
  ...
  // W KEY (UP)
    ...
    if (player.getJsonFile().equals("sprites/slime_down.json") || player.getJsonFile().equals("sprites/slime_left.json") || player.getJsonFile().equals("sprites/slime_right.json")) {
      player = new AnimatedSprite("sprites/slime_up.png", player.getCenterX()-10.5f, player.getCenterY()-7.5f, "sprites/slime_up.json");
    }
    up = true;
  }
  ...
  // D KEY (RIGHT)
    ...
    if (player.getJsonFile().equals("sprites/slime_down.json") || player.getJsonFile().equals("sprites/slime_left.json") || player.getJsonFile().equals("sprites/slime_up.json")) {
      player = new AnimatedSprite("sprites/slime_right.png", player.getCenterX()-10.5f, player.getCenterY()-7.5f, "sprites/slime_right.json");
    }
    right = true;
  }
  ...
  // S KEY (DOWN)
    ...
    if (player.getJsonFile().equals("sprites/slime_up.json") || player.getJsonFile().equals("sprites/slime_left.json") || player.getJsonFile().equals("sprites/slime_right.json")) {
      player = new AnimatedSprite("sprites/slime_down.png", player.getCenterX()-10.5f, player.getCenterY()-7.5f, "sprites/slime_down.json");
    }
    down = true;
  }
...
public void handleCollisions(){
  ...
  if (player.getBottom() > bg.height-80.0f) {
    player.animateMove(0.0f, -1.25f, 0.1f, true);
  }
  ...
  if (player.getRight() > bg.width-80.0f) {
    player.animateMove(-1.25f, 0.0f, 0.1f, true);
  }
}
...
public void animationSetup(){  
  int i = 2;
  exampleSprite = new AnimatedSprite("sprites/ice_horse_run.png", 50.0f, i*75.0f, "sprites/ice_horse_run.json");
  exampleSprite2 = new AnimatedSprite("sprites/horse_run.png", 50.0f, i*75.0f, "sprites/horse_run.json");
  player = new AnimatedSprite("sprites/slime_down.png", 400.0f, 400.0f, "sprites/slime_down.json");
...
public void checkExampleAnimation(){
  ...
  if (ghoul.getJsonFile().equals("sprites/ghoul_left.json") && player.getCenterX() > ghoul.getCenterX()) {
    ghoul = new AnimatedSprite("sprites/ghoul_right.png", ghoul.getCenterX()-23.5f, ghoul.getCenterY()-37.5f, "sprites/ghoul_right.json");
  }
  if (ghoul.getJsonFile().equals("sprites/ghoul_right.json") && player.getCenterX() < ghoul.getCenterX()) {
    ghoul = new AnimatedSprite("sprites/ghoul_left.png", ghoul.getCenterX()-23.5f, ghoul.getCenterY()-37.5f, "sprites/ghoul_left.json");
  }
