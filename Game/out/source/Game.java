 ...
 public void keyPressed() {
  ...
  if(keyCode == 65 || keyCode == 37) {
    if (player.getJsonFile().equals("sprites/slime_down.json") || player.getJsonFile().equals("sprites/slime_up.json") || player.getJsonFile().equals("sprites/slime_right.json")) {
      player = new AnimatedSprite("sprites/slime_left.png", player.getCenterX()-10.5f, player.getCenterY()-7.5f, "sprites/slime_left.json", player.getHealth());
    }
    left = true;
  }
  ...
  // W KEY (UP)
    ...
    if (player.getJsonFile().equals("sprites/slime_down.json") || player.getJsonFile().equals("sprites/slime_left.json") || player.getJsonFile().equals("sprites/slime_right.json")) {
      player = new AnimatedSprite("sprites/slime_up.png", player.getCenterX()-10.5f, player.getCenterY()-7.5f, "sprites/slime_up.json", player.getHealth());
    }
    up = true;
  }
  ...
  // D KEY (RIGHT)
    ...
    if (player.getJsonFile().equals("sprites/slime_down.json") || player.getJsonFile().equals("sprites/slime_left.json") || player.getJsonFile().equals("sprites/slime_up.json")) {
      player = new AnimatedSprite("sprites/slime_right.png", player.getCenterX()-10.5f, player.getCenterY()-7.5f, "sprites/slime_right.json", player.getHealth());
    }
    right = true;
  }
  ...
  // S KEY (DOWN)
    ...
    if (player.getJsonFile().equals("sprites/slime_up.json") || player.getJsonFile().equals("sprites/slime_left.json") || player.getJsonFile().equals("sprites/slime_right.json")) {
      player = new AnimatedSprite("sprites/slime_down.png", player.getCenterX()-10.5f, player.getCenterY()-7.5f, "sprites/slime_down.json", player.getHealth());
    }
    down = true;
  }
  ...
  if (left == true && right == false) {
    player.animateMove(-0.75f, 0.0f, 0.1f, true);
  }
  ...
  if (left == false && right == false) {
    player.animateMove(0.0f, 0.0f, 0.1f, true);
  }

  // VERTICAL
  // player up method
  if (up == true && down == false) {
    player.animateMove(0.0f, -0.75f, 0.1f, true);
  }
...
public void handleCollisions(){
  ...
  // WALL COLLISIONS
  if (player.getTop() < 80) {
    player.animateMove(0.0f, 1.25f, 0.1f, true);
  }

  if (player.getBottom() >   currentScreen.getBg().height-80.0f) {
    player.animateMove(0.0f, -1.25f, 0.1f, true);
  }

  if (player.getLeft() < 80.0f) {
    player.animateMove(1.25f, 0.0f, 0.1f, true);
  }

  if (player.getRight() > currentScreen.getBg().width-80.0f) {
    player.animateMove(-1.25f, 0.0f, 0.1f, true);
  }
}
...
public void animationSetup(){  
  int i = 2;
  exampleSprite = new AnimatedSprite("sprites/ice_horse_run.png", 50.0f, i*75.0f, "sprites/ice_horse_run.json", 5);
  exampleSprite2 = new AnimatedSprite("sprites/horse_run.png", 50.0f, i*75.0f, "sprites/horse_run.json", 5);
  player = new AnimatedSprite("sprites/slime_down.png", 400.0f, 400.0f, "sprites/slime_down.json", 5);
...
public void checkAnimations(){
  if(doAnimation){
    exampleSprite.animateVertical(1.0f, 3.0f, true);
    exampleSprite2.animateHorizontal(1.0f, 3.0f, true);
  }
  player.animate(0.1f);
  ...
  if (ghoul.getHealth() == 0) {
    ...
    ghoul.animateMove(0.0f, 0.0f, 0.0f, false);
  }
  else {
    ghoul.animateToPlayer(player, 1.0f, true);
  }

  for (AnimatedSprite g : currentWorld.getSprites()) {
    g.animateToPlayer(player, 1.0f, true);
  }

  //Switch direction of ghoul image
  if (ghoul.getJsonFile().equals("sprites/ghoul_left.json") && player.getCenterX() > ghoul.getCenterX()) {
    ghoul = new AnimatedSprite("sprites/ghoul_right.png", ghoul.getCenterX()-23.5f, ghoul.getCenterY()-37.5f, "sprites/ghoul_right.json", ghoul.getHealth());
  }
  if (ghoul.getJsonFile().equals("sprites/ghoul_right.json") && player.getCenterX() < ghoul.getCenterX()) {
    ghoul = new AnimatedSprite("sprites/ghoul_left.png", ghoul.getCenterX()-23.5f, ghoul.getCenterY()-37.5f, "sprites/ghoul_left.json", ghoul.getHealth());
  }
...
public class AnimatedSprite extends Sprite{
  ...
  public void attack(AnimatedSprite target) {
    ...
    if ((xD >= 0.0f && xD <= 50.0f) || (xD <= 0.0f && xD >= -50.0f) || (yD >= 0.0f && yD <= 50.0f) || (yD <= 0.0f && yD >= -50.0f)) {
      target.setHealth(target.getHealth()-1);
      
      // If player is to the right of target, target moves to the left.
      if (xD >= 0.0f && xD <= 50.0f) {
        target.animateMove(10.0f, 0.0f, 0.1f, true);
      }
      ...
      if (yD >= 0.0f && yD <= 50.0f) {
        target.animateMove(0.0f, 10.0f, 0.1f, true);
      }
