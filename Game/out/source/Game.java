...
public void exampleAnimationSetup(){  
  ...
  slime = new AnimatedSprite("sprites/slime_down.png", 400.0f, 400.0f, "sprites/slime_down.json");
}

//example method that animates the horse Sprites
public void checkExampleAnimation(){
  if(doAnimation){
    exampleSprite.animateVertical(1.0f, 1.0f, true);
    exampleSprite2.animateHorizontal(1.0f, 1.0f, true);
  }
  slime.animate(0.1f);
}
